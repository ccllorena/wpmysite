    ...
    <div class="site-top-bar border-bottom">
        <div class="site-container">
            ...
            <div class="site-top-bar-right">
                ...
                <div class="site-top-bar-left-text"><?php //echo wp_kses_post( get_theme_mod( 'topshop-header-info-text', 'Call Us: 082 444 BOOM' ) ) ?><i class="fa fa-envelope fa-lg"  aria-hidden="true"><span style="font-family: sans-serif;"> clauido@programadorinformatico.cl  </span></i><i class="fa fa-mobile fa-lg"  aria-hidden="true"><span style="font-family: sans-serif;"> +56 930 110 665  </span></i><i class="fa fa-user-circle fa-lg"  aria-hidden="true"><span style="font-family: sans-serif;"><a href="http://wpmysite.local/contacto/"> Contaco</a>  </span></i> </div>
