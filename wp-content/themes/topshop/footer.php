...
<footer id="colophon" class="site-footer <?php echo ( get_theme_mod( 'topshop-footer-switch-bottombar' ) ) ? sanitize_html_class( 'site-footer-bottom-bar-switch' ) : ''; ?>" role="contentinfo">
    ...
    <div class="site-footer-widgets">
        <div class="site-container">
			...
			<?php printf( __( '</div></div><div class="site-footer-bottom-bar"><div class="site-container"><div class="site-footer-bottom-bar-left">Desarrollo por %2$s', 'topshop' ), 'TopShop', '<a href="https://programadorinformatico.cl/">Programador Informatico</a></div><div class="site-footer-bottom-bar-right">' ); ?>
